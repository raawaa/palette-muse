...
class ThemeFactoryTest {
    ...
    fun createSeed_returnsThemeWithGeneratedId() {
        val (theme, photo) = factory.createSeed("Warm Red", "#DCA8A6", "/seed.jpg")
    ...
    fun createSeed_photoIsSeed() {
        val (_, photo) = factory.createSeed("Warm Red", "#DCA8A6", "/seed.jpg")
    ...
    fun createCapture_returnsPhotoWithGeneratedId() {
        val photo = factory.createCapture("theme-1", "#DCA8A6", "/cap.jpg")
        assertTrue(photo.id.isNotEmpty())
    ...
    fun createCapture_generatesUniqueIds() {
        val a = factory.createCapture("theme-1", "#DCA8A6", "/cap1.jpg")
        val b = factory.createCapture("theme-1", "#DCA8A6", "/cap2.jpg")
